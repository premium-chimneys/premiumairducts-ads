      ...
      <div className="fb-card">
        ...
        <div className="fb-grid">
          <div>
            ...
            <p className="fb-desc">
              Every job we take on starts the same way — a homeowner who finally picked up the phone. Book today and know exactly where your home&apos;s HVAC system stands.
            </p>
...
const css = `
  .fb-card {
    ...
    margin: 0 auto;
    width: calc(100% - 48px);
    background: linear-gradient(135deg, #101a25 0%, #0d131e 50%, #101a25 100%);
    border-radius: 24px;
    overflow: hidden;
    position: relative;
