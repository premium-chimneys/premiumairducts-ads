...
export default function AnnouncementBar({ city }) {
  useEffect(() => {
    try {
      (function() {
        ...
        function draw() {
          ...
          for (var i = stars.length - 1; i >= 0; i--) {
            ...
            grad.addColorStop(0.6, 'rgba(59, 130, 246, ' + (s.opacity * 0.25) + ')');
            grad.addColorStop(1, 'rgba(147, 197, 253, ' + (s.opacity * 0.9) + ')');
            ...
            ctx.fillStyle = 'rgba(219, 234, 254, ' + (s.opacity * 0.95) + ')';
            ctx.fill();
          }
          ...
          for (var k = 0; k < glintStars.length; k++) {
            ...
            if (g.opacity > 0) {
              ...
              glow.addColorStop(0, 'rgba(219, 234, 254, ' + (g.opacity * 0.95) + ')');
  ...
  return (
    <>
      ...
      `}} />
      <a href={`tel:${city?.phone ?? ''}`} className="announcement-bar" style={{ textDecoration: 'none', color: 'inherit' }}>
        ...
        <div className="announcement-content">
          ...
          <span className="announcement-text">
            Get <strong>$100 OFF</strong> air duct cleaning this month only!
          </span>
