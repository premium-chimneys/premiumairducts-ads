...
const svgProps = {
  ...
  style: { position: 'relative', zIndex: 1, filter: 'drop-shadow(0 1px 1px rgba(15, 29, 80, 0.35))' },
};
    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .nav-services-dropdown {
          ...
          border-radius: 18px;
          box-shadow:
            0 32px 80px rgba(29, 78, 216, 0.18),
        ...
        .nav-service-icon {
          ...
          background:
            ...
            linear-gradient(160deg, #0b0f18 0%, #101a30 45%, #152448 100%);
        ...
        .nav-apply {
          ...
          box-shadow:
            inset 0 1px 0 rgba(155, 196, 240, 0.55),
            inset 0 -1px 0 rgba(0, 0, 0, 0.22),
            0 2px 10px rgba(29, 78, 216, 0.45);
          letter-spacing: 0.01em;
        ...
        .nav-apply:active {
          ...
          box-shadow:
            inset 0 1px 0 rgba(155, 196, 240, 0.4),
            inset 0 -1px 0 rgba(0, 0, 0, 0.22),
            0 2px 6px rgba(29, 78, 216, 0.3);
        }
      ...
      <nav className="nav-wrapper" id="navWrapper">
        <div className="nav-inner">
          ...
          {/* Logo */}
          <a href={`/${city?.slug ?? ''}/home`} className="nav-logo">
            <img src="https://cdn.prod.website-files.com/6799d9a297e7d4a19dd1cc25/69c32152dbdd4be60288e6b5_Premium%20Air%20Ducts%20Primary%20Logo.webp" alt="Premium Air Ducts" />
          </a>

          {/* Nav links */}
          <div className="nav-links">
            <a href={`/${city?.slug ?? ''}/home`} className="nav-link">Home</a>
            <a href={`/${city?.slug ?? ''}/about`} className="nav-link">About</a>
            ...
            <a href={`/${city?.slug ?? ''}/blog`} className="nav-link">Blog</a>
            <a href={`/${city?.slug ?? ''}/contact`} className="nav-link">Contact</a>
          </div>
          ...
          <div className="nav-ctas">
            <a href={`tel:${city.phone}`} className="nav-phone">
              ...
              <span className="wc-phone-text">{city.phone_text}</span>
            </a>
