    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .tm-guarantee-center {
          ...
          height: 64px;
          border-radius: 50%;
          background: linear-gradient(135deg, #2563eb, #5d9be5);
          display: flex;
          align-items: center;
          justify-content: center;
          ...
          <div className="tm-header">
            ...
            <div className="tm-guarantee">
              <svg className="tm-guarantee-ring" viewBox="0 0 120 120">
                ...
                <text fontSize="11" fontWeight="700" fill="#2563eb" fontFamily="'Inter Tight', sans-serif" letterSpacing="3">
      ...
      <div style={{ background: '#f8fafc' }}>
        <div className="tm-widget" style={{ boxSizing: 'border-box', maxWidth: '1200px', margin: '0 auto', padding: '0 24px 72px', marginTop: '0' }}>
          <div className="elfsight-app-79fe4175-701e-4ddf-90e7-8484d1cf4949" data-elfsight-app-lazy={true}></div>
        </div>
      </div>
    </>
  );
