    ...
    try {
      (function() {
        ...
        function openCalendly() {
          if (window.Calendly) {
            Calendly.initPopupWidget({ url: getCalendlyUrl('https://calendly.com/hello-ztry/inspection') });
          }
        }
  ...
  return (
    <>
      ...
      <section className="hero">
        <img className="hero-video" src="https://cdn.prod.website-files.com/6799d9a297e7d4a19dd1cc25/69c2d3102433cca680c0021f_hvac-technician-servicing-outdoor-ac-unit.webp" alt="" />
          ...
          <div className="hero-left">
            <div className="hero-badges">
              ...
              <div className="hero-reviews">
                <div className="elfsight-app-07c916c6-13a3-474b-a938-98c826309b47" data-elfsight-app-lazy={true}></div>
              </div>
            </div>
      
            <h1 className="hero-h1">AC Repair & Air<br />Duct Cleaning in {city.name}</h1>
      
            <p className="hero-desc">Premium Air Ducts provides professional HVAC services for homeowners. Our mission is to help you create a clean environment for your home.</p>
