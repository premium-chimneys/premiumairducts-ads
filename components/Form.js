...
.hero-form-card {
  ...
  overflow: hidden;
  box-shadow: 0 24px 48px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(255, 255, 255, 0.2), 0 0 80px rgba(37, 99, 235, 0.08);
...
.hero-form-card::before {
  ...
  height: 3px;
  background: linear-gradient(90deg, #2563eb, #60a5fa, #38bdf8, #0ea5e9, #38bdf8, #60a5fa, #2563eb);
...
.hero-form-card::after {
  ...
  box-shadow: 0 0 30px 8px rgba(37, 99, 235, 0.08);
  pointer-events: none;
  z-index: 0;
...
.hero-form-textarea::placeholder { color: #a4b0c4; }

.hero-form-input:focus,
.hero-form-textarea:focus {
  border-color: #2563eb;
  background: #ffffff;
  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1), 0 0 20px rgba(37, 99, 235, 0.04);
}
...
.hero-form-phone-input::placeholder { color: #a4b0c4; }
...
.hero-form-submit {
  ...
  border: none;
  border-radius: 12px;
  background: linear-gradient(160deg, #5d9be5 0%, #2563eb 40%, #1d4ed8 100%);
  cursor: pointer;
  transition: all 0.25s ease;
  position: relative;
  overflow: hidden;
...
.hero-form-success h3 {
  ...
  color: #121a25; margin: 0 0 10px; letter-spacing: -0.02em;
  animation: heroFormTextSlideUp 0.5s ease-out 0.4s both;
}

.hero-form-success p {
  font-family: 'Inter Tight', sans-serif; font-size: 14px; color: #6f7c94;
