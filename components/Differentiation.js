            ...
            <div className="df-table">
              ...
              <div className="df-thead">
                ...
                <div className="df-cell df-cell-premium">
                  <span className="df-col-title df-col-title-premium">Premium Air Ducts</span>
...
const css = `
  ...
  .df-bg {
    ...
    background:
      radial-gradient(ellipse 60% 35% at 15% 18%, rgba(96,165,250,0.22), transparent 70%),
      radial-gradient(ellipse 45% 30% at 85% 38%, rgba(212,165,116,0.16), transparent 70%),
      radial-gradient(ellipse 80% 25% at 50% 0%, rgba(37,99,235,0.1), transparent 70%);
  ...
  .df-title {
    ...
    letter-spacing: -0.04em; color: #121a25;
    margin: 0 0 28px;
  }
  .df-title-accent {
  ...
  .df-proof-text::before, .df-proof-text::after {
    ...
    background: linear-gradient(90deg, transparent, rgba(212,165,116,0.7), rgba(37,99,235,0.5));
  }
  ...
  .df-card {
    ...
    overflow: hidden;
    box-shadow:
      0 24px 80px rgba(29,78,216,0.14),
      0 8px 24px rgba(29,78,216,0.06);
  }
  .df-card-glow {
    position: absolute;
  ...
  .df-premium-spotlight {
    ...
    width: 31.4%;
    background:
      linear-gradient(180deg, rgba(212,165,116,0.05), rgba(37,99,235,0.05) 50%, rgba(212,165,116,0.04));
  ...
  .df-row:hover .df-cell { background: rgba(37,99,235,0.025); }
  ...
  .df-col-title-premium { color: #121a25; }
  .df-col-stamp {
    margin-left: auto;
  ...
  .df-row-icon {
    ...
    border-radius: 10px;
    display: grid; place-items: center;
    background: linear-gradient(160deg, rgba(96,165,250,0.18), rgba(37,99,235,0.06));
  ...
  .df-card-foot {
    ...
    background: linear-gradient(180deg, rgba(37,99,235,0.04), rgba(212,165,116,0.04));
  ...
  .df-foot-num {
    ...
    background: linear-gradient(180deg, #121a25 30%, #1d4ed8);
