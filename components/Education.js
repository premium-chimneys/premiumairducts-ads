...
const css = `
  ...
  .ed-sig-violet { background: #60a5fa; box-shadow: 0 0 10px rgba(96,165,250,0.8); animation-delay: 0.5s; }
  ...
  .ed-step-line {
    ...
    background: linear-gradient(90deg, rgba(96,165,250,0.6), rgba(232,121,249,0.6));
  }

  .ra-title-accent-cool {
    background: linear-gradient(135deg, #93c5fd, #60a5fa, #3b82f6, #60a5fa, #93c5fd);
  ...
  .pa-row-frame {
    ...
    padding: 1px;
    background: linear-gradient(120deg, var(--tone, rgba(245,158,11,0.5)), transparent 40%, transparent 70%, rgba(132,192,252,0.2));
  ...
  .pa-tone-amber  .pa-row-frame { background: linear-gradient(120deg, rgba(245,158,11,0.5), transparent 50%, rgba(132,192,252,0.18)); }
  .pa-tone-red    { --tone: rgba(251,113,133,0.7); }
  .pa-tone-red    .pa-row-frame { background: linear-gradient(120deg, rgba(251,113,133,0.5), transparent 50%, rgba(132,192,252,0.18)); }
  .pa-tone-violet { --tone: rgba(96,165,250,0.7); }
  .pa-tone-violet .pa-row-frame { background: linear-gradient(120deg, rgba(96,165,250,0.5), transparent 50%, rgba(245,158,11,0.18)); }
  ...
  .pa-tone-violet .pa-severity { color: #93c5fd; border-color: rgba(96,165,250,0.4); background: rgba(96,165,250,0.08); }
  .pa-arrow {
  ...
  .ra-tag-dot { width: 7px; height: 7px; border-radius: 100px; background: #38bdf8; box-shadow: 0 0 14px #38bdf8; animation: ra-pulse 2s ease-in-out infinite; }
  .ra-title { font-size: 48px; font-weight: 700; line-height: 1.08; letter-spacing: -0.04em; color: #fff; margin: 0 0 18px; }
  .ra-title-accent {
    background: linear-gradient(135deg, #60a5fa, #38bdf8, #fbbf24, #38bdf8, #60a5fa);
    background-size: 200% auto;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
  ...
  .ra-panel::before {
    ...
    border-radius: inherit;
    padding: 1px;
    background: linear-gradient(160deg, rgba(96,165,250,0.4), transparent 50%, rgba(132,192,252,0.18));
    -webkit-mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0);
    -webkit-mask-composite: xor;
            mask-composite: exclude;
    pointer-events: none;
  }
  .ra-panel-now:hover { transform: translateY(-4px); border-color: rgba(96,165,250,0.45); box-shadow: 0 24px 60px rgba(29,78,216,0.32); }
  ...
  .ra-panel-cost-prefix { font-size: 32px; font-weight: 700; color: rgba(147,197,253,0.7); margin-top: 18px; }
  .ra-panel-cost-num {
    font-size: 96px; font-weight: 800; letter-spacing: -0.05em;
    background: linear-gradient(180deg, #ffffff 30%, #60a5fa);
  ...
  .ra-panel-cost-sub { font-size: 12px; font-weight: 600; letter-spacing: 0.12em; color: rgba(147,197,253,0.7); margin-bottom: 38px; }
  ...
  .ra-icon-check {
    background: linear-gradient(135deg, rgba(96,165,250,0.35), rgba(37,99,235,0.18));
  ...
  .ra-divider-line { flex: 1; width: 1px; background: linear-gradient(180deg, transparent, rgba(96,165,250,0.4), rgba(245,158,11,0.4), transparent); }
  .ra-divider-orb {
    position: relative;
    ...
    border: 1px solid rgba(132,192,252,0.5);
    color: #ffffff;
  ...
  .ra-divider-orb-glow {
    ...
    background: conic-gradient(from 0deg, rgba(96,165,250,0.4), rgba(245,158,11,0.4), rgba(96,165,250,0.4));
  ...
  .op-grid-line {
    ...
    height: 1px;
    background: linear-gradient(90deg, transparent, rgba(96,165,250,0.35) 10%, rgba(232,121,249,0.45) 50%, rgba(96,165,250,0.35) 90%, transparent);
    pointer-events: none;
  }
  .op-card {
    position: relative;
    ...
    border-radius: 22px;
    background: linear-gradient(180deg, rgba(37,99,235,0.08), rgba(10,5,20,0.2) 60%), rgba(255,255,255,0.02);
    border: 1px solid rgba(96,165,250,0.18);
    overflow: hidden;
    backdrop-filter: blur(6px);
    opacity: 0;
  ...
  .op-card::after {
    ...
    border-radius: inherit;
    padding: 1px;
    background: linear-gradient(160deg, rgba(132,192,252,0.25), transparent 40%, transparent 70%, rgba(232,121,249,0.18));
    -webkit-mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0);
    -webkit-mask-composite: xor;
            mask-composite: exclude;
    pointer-events: none;
  }
  .op-card:hover { transform: translateY(-4px); border-color: rgba(132,192,252,0.45); box-shadow: 0 24px 60px rgba(29,78,216,0.35), 0 0 0 1px rgba(132,192,252,0.15); }
  .op-card-ghost {
    position: absolute;
    top: -34px; right: -12px;
    ...
    color: transparent;
    -webkit-text-stroke: 1.5px rgba(96,165,250,0.1);
    pointer-events: none; user-select: none;
  }
  .op-card-marker { position: absolute; top: 64px; left: 50%; transform: translate(-50%, -50%); width: 18px; height: 18px; }
  .op-card-marker-ring { position: absolute; inset: 0; border-radius: 100px; border: 1px solid rgba(132,192,252,0.5); background: #03060c; }
  .op-card-marker-dot {
    position: absolute; inset: 4px; border-radius: 100px;
    background: linear-gradient(135deg, #60a5fa, #0ea5e9);
    box-shadow: 0 0 16px rgba(132,192,252,0.75);
  ...
  .op-list::before { content: ''; position: absolute; left: 0; top: 6px; bottom: 6px; width: 1px; background: linear-gradient(180deg, rgba(96,165,250,0.45), rgba(96,165,250,0.08)); }
  ...
  .op-item-node {
    ...
    background: #03060c;
    border: 1.5px solid rgba(132,192,252,0.7);
    box-shadow: 0 0 10px rgba(132,192,252,0.5);
  }
  ...
  .op-item-preview { font-size: 12px; font-weight: 500; color: rgba(147,197,253,0.65); letter-spacing: 0.02em; }
  .op-item-pill {
  ...
  @media (max-width: 1040px) {
    ...
    .ra-divider-line { width: auto; height: 1px; flex: 1; background: linear-gradient(90deg, transparent, rgba(96,165,250,0.4), rgba(245,158,11,0.4), transparent); }
