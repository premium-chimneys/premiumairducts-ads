...
export default function WhatsIncluded({ city, serviceData }) {
  ...
  useEffect(() => {
    try {
      ...
      if (!btn) return;
      const handler = () => {
        const url = getCalendlyUrl('https://calendly.com/hello-ztry/inspection');
          ...
          <div className="wi-grid">
            <div className="wi-image-wrap">
              <div className="wi-image-frame">
                <img
                  className="wi-image"
                  src="https://cdn.prod.website-files.com/6799d9a297e7d4a19dd1cc25/69c2d3102433cca680c0021f_hvac-technician-servicing-outdoor-ac-unit.webp"
                  alt="Premium Air Ducts technician servicing an outdoor HVAC unit"
                />
...
const css = `
  ...
  .wi-bg {
    ...
    background:
      radial-gradient(ellipse 60% 50% at 15% 30%, rgba(96,165,250,0.22), transparent 70%),
      radial-gradient(ellipse 50% 40% at 85% 70%, rgba(232,121,249,0.14), transparent 70%),
      linear-gradient(180deg, #f8fafc, #edf3ff);
    pointer-events: none;
  }
  ...
  .wi-lede { font-size: 16px; line-height: 1.65; color: #5b6b86; margin: 0; }
  ...
  .wi-image-frame {
    ...
    overflow: hidden;
    box-shadow:
      0 30px 80px rgba(29,78,216,0.28),
  ...
  .wi-card {
    ...
    box-shadow:
      0 14px 40px rgba(29,78,216,0.1),
  ...
  .wi-card::before {
    ...
    padding: 1px;
    background: linear-gradient(135deg, rgba(96,165,250,0.5), transparent 50%, rgba(232,121,249,0.3));
  ...
  .wi-card-orb {
    ...
    background: linear-gradient(160deg, rgba(96,165,250,0.35), rgba(232,121,249,0.18));
  ...
  .wi-card-orb-glow {
    ...
    border-radius: inherit;
    background: radial-gradient(circle, rgba(132,192,252,0.35), transparent 70%);
    filter: blur(8px);
    pointer-events: none;
    z-index: 0;
  }
  ...
  .wi-card-num {
    ...
    line-height: 1;
    color: transparent;
    -webkit-text-stroke: 1.2px rgba(37,99,235,0.3);
  ...
  .wi-cta {
    margin-top: 56px;
    border-radius: 20px;
    background: linear-gradient(135deg,#0b0f18,#101a30 50%,#0b0f18);
  ...
  .wi-cta:hover { border-color: rgba(37,99,235,.4); box-shadow: 0 16px 48px rgba(37,99,235,.12), 0 0 80px rgba(37,99,235,.04); }
  .wi-cta::before {
    content: '';
    position: absolute; top: 0; left: 0; right: 0;
    height: 2px;
    background: linear-gradient(90deg, transparent, #2563eb, #60a5fa, #38bdf8, #60a5fa, #2563eb, transparent);
  ...
  .wi-cta-badge-label { font-size: 12px; font-weight: 700; color: #60a5fa; letter-spacing: .02em; margin-bottom: 4px; }
  .wi-cta-badge-amount { font-size: 40px; font-weight: 800; letter-spacing: -.03em; line-height: 1; background: linear-gradient(180deg,#fff 30%,#60a5fa 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
  ...
  .wi-cta-btn {
    ...
    font-size: 15px; font-weight: 600; color: #e0f0fd;
    padding: 14px 32px; border-radius: 12px;
    border: 1px solid #2563eb;
    background: linear-gradient(160deg,#5d9be5,#2563eb 25%,#1e40af 50%,#1d4ed8 72%,#3b82f6);
    box-shadow: inset 0 1px 0 rgba(155,196,240,.55), inset 0 -1px 0 rgba(0,0,0,.22), 0 4px 20px rgba(29,78,216,.5);
  ...
  .wi-cta-btn:hover {
    ...
    box-shadow: inset 0 1px 0 rgba(155,196,240,.55), inset 0 -1px 0 rgba(0,0,0,.22), 0 8px 28px rgba(29,78,216,.6);
    border-color: #3b82f6;
  }
